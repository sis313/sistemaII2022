...
public class UserEntity {
    ...
    public boolean equals(Object o) {
        ...
        return idUser == that.idUser && idTypeUser == that.idTypeUser && Objects.equals(name, that.name)
                && Objects.equals(email, that.email) && Objects.equals(nickname, that.nickname)
                && Objects.equals(password, that.password) && Objects.equals(createDate, that.createDate)
                && Objects.equals(updateDate, that.updateDate) && Objects.equals(status, that.status);
    }
